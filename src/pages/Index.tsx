...
const quickAccess = [
  ...
  { title: "Law GAT preparation", description: "A structured law bank is planned for the next stage.", icon: Target, action: "Coming soon", active: false },
  ...
  { title: "Latest information", description: "Exam updates and notices will be added after Phase 1.", icon: FileText, action: "Coming soon", active: false },
];
